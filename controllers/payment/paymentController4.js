...
const paymentmanage = async (req, res) => {
  if (req.body.test) {
    const data = {
      ...
      redirectUrl: `http://localhost:7070/api/payment/response?test=${req.body.test}&transactionId=${req.body.transection_id}`,
      redirectMode: "GET",
      callbackUrl:
    ...
    const data = {
      ...
      merchantUserId: "MUID123",
      amount: req.body.amount * 100,
      redirectUrl: `http://transserver-env.eba-ieqecsf3.ap-south-1.elasticbeanstalk.com//api/payment/response?test=${req.body.test}&transactionId=${req.body.transection_id}`,
      redirectMode: "GET",
      callbackUrl:
